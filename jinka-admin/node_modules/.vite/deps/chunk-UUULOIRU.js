  ...
  "node_modules/papaparse/papaparse.min.js"(exports2, module2) {
    ((e, t) => {
      ...
      function i2(m3) {
        ...
        function g3() {
          if (p4 && a2 && (k3("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + v.DefaultDelimiter + "'"), a2 = false), m3.skipEmptyLines && (p4.data = p4.data.filter(function(e3) {
            return !y3(e3);
          })), _3()) {
          ...
          function i4(e3, t3) {
            ...
            return m3.header && (r4 > c3.length ? k3("FieldMismatch", "TooManyFields", "Too many fields: expected " + c3.length + " fields but parsed " + r4, f3 + t3) : r4 < c3.length && k3("FieldMismatch", "TooFewFields", "Too few fields: expected " + c3.length + " fields but parsed " + r4, f3 + t3)), i5;
          }
          var r3;
      ...
      function E2(C2) {
        var S = (C2 = C2 || {}).delimiter, O = C2.newline, x = C2.comments, I3 = C2.step, A2 = C2.preview, T3 = C2.fastMode, D = null, L2 = false, F = null == C2.quoteChar ? '"' : C2.quoteChar, j = F;
        ...
        this.parse = function(i3, t, r2) {
          ...
          if (T3 || false !== T3 && -1 === i3.indexOf(F)) {
            for (var l3 = i3.split(O), c3 = 0; c3 < l3.length; c3++) {
              ...
              if (!x || d4.substring(0, a2) !== x) {
                if (o3) {
                  if (h2 = [], k3(d4.split(S)), R2(), M) return w();
                } else k3(d4.split(S));
                if (A2 && A2 <= c3) return h2 = h2.slice(0, A2), w(true);
              }
            }
            return w();
          }
          for (var p4 = i3.indexOf(S, z2), g3 = i3.indexOf(O, z2), _3 = new RegExp(P(j) + P(F), "g"), m3 = i3.indexOf(F, z2); ; ) if (i3[z2] === F) for (m3 = z2, z2++; ; ) {
            ...
            if (F === j && i3[m3 + 1] === j) m3++;
              ...
              if (i3.substring(m3 + 1 + y3, m3 + 1 + y3 + s2) === O) {
                ...
                if (A2 && h2.length >= A2) return w(true);
                break;
              }
          ...
          function E3(e2) {
            return r2 || (void 0 === e2 && (e2 = i3.substring(z2)), d4.push(e2), z2 = n2, k3(d4), o3 && R2()), w();
          }
          function b2(e2) {
            z2 = e2, k3(d4), d4 = [], g3 = i3.indexOf(O, z2);
          }
          function w(e2) {
...
var ns = o((e) => {
  ...
  let t = e.map((i2) => ({ ...i2, splitted: it(Ae(i2.route)) })), r = ((n = t[0]) == null ? void 0 : n.splitted.length) ?? 0, s = [...t];
...
var ps = o((e) => it(Ae(e)).flatMap((r) => It(r) ? [r.slice(1)] : []), "pickRouteParams");
...
function lo({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = oe(), s = Pe(), { replace: n } = he(), { forgotPassword: i2 } = xe(), { forgotPassword: a } = Ue(), { close: u2, open: c2 } = He(), { keys: p3, preferLegacyKeys: l2 } = Z(), m2 = useMutation({ mutationKey: p3().auth().action("forgotPassword").get(l2), mutationFn: a, onSuccess: ({ success: d3, redirectTo: T3, error: x, successNotification: v }) => {
    d3 && (u2 == null || u2("forgot-password-error"), v && (c2 == null || c2(ka(v)))), (x || !d3) && (c2 == null || c2(po(x))), T3 && (r === "legacy" ? n(T3) : s({ to: T3, type: "replace" }));
  }, onError: (d3) => {
    c2 == null || c2(po(d3));
...
var ka = o((e) => ({ message: e.message, description: e.description, key: "forgot-password-success", type: "success" }), "buildSuccessNotification");
...
var $t = o(({ resource: e, config: t, filters: r, hasPagination: s, pagination: n, sorters: i2, queryOptions: a, successNotification: u2, errorNotification: c2, meta: p3, metaData: l2, liveMode: m2, onLiveEvent: y2, liveParams: d3, dataProviderName: T3, overtimeOptions: x } = {}) => {
  ...
  let re = useQuery({ queryKey: A2().data(L2).resource(P ?? "").action("list").params({ ...U || {}, filters: w, hasPagination: V, ...V && { pagination: F }, ...i2 && { sorters: i2 }, ...(t == null ? void 0 : t.sort) && { sort: t == null ? void 0 : t.sort } }).get(E2), queryFn: (R2) => {
...
var zt = o(({ resource: e, id: t, queryOptions: r, successNotification: s, errorNotification: n, meta: i2, metaData: a, liveMode: u2, onLiveEvent: c2, liveParams: p3, dataProviderName: l2, overtimeOptions: m2 }) => {
  let { resources: y2, resource: d3, identifier: T3 } = q(e), x = le(), v = z(), f2 = ie(), { mutate: P } = Re({ v3LegacyAuthProviderCompatible: !!(f2 != null && f2.isLegacy) }), M = Ce(), Q = ue(), { keys: g2, preferLegacyKeys: C2 } = Z(), h = I2(i2, a), D = ee(T3, l2, y2), { getOne: A2 } = x(D), E2 = Q({ resource: d3, meta: h });
  ...
  let L2 = useQuery({ queryKey: g2().data(D).resource(T3 ?? "").action("one").id(t ?? "").params({ ...h || {} }).get(C2), queryFn: (w) => A2({ resource: (d3 == null ? void 0 : d3.name) ?? "", id: t, meta: { ...E2, queryContext: je(w) }, metaData: { ...E2, queryContext: je(w) } }), ...r, enabled: typeof (r == null ? void 0 : r.enabled) < "u" ? r == null ? void 0 : r.enabled : typeof t < "u", onSuccess: (w) => {
    var b;
...
var go = o(({ resource: e, ids: t, queryOptions: r, successNotification: s, errorNotification: n, meta: i2, metaData: a, liveMode: u2, onLiveEvent: c2, liveParams: p3, dataProviderName: l2, overtimeOptions: m2 }) => {
  let { resources: y2, resource: d3, identifier: T3 } = q(e), x = le(), v = z(), f2 = ie(), { mutate: P } = Re({ v3LegacyAuthProviderCompatible: !!(f2 != null && f2.isLegacy) }), M = Ce(), Q = ue(), { keys: g2, preferLegacyKeys: C2 } = Z(), h = I2(i2, a), D = ee(T3, l2, y2), A2 = (r == null ? void 0 : r.enabled) === void 0 || (r == null ? void 0 : r.enabled) === true, { getMany: E2, getOne: L2 } = x(D), U = Q({ resource: d3, meta: h }), w = Array.isArray(t), N = !!(d3 != null && d3.name), b = (r == null ? void 0 : r.enabled) === true;
  (0, import_warn_once2.default)(!w && !b, za(t, d3 == null ? void 0 : d3.name)), (0, import_warn_once2.default)(!N && !b, _a()), Pt({ resource: T3, types: ["*"], params: { ids: t ?? [], meta: U, metaData: U, subscriptionType: "useMany", ...p3 }, channel: `resources/${(d3 == null ? void 0 : d3.name) ?? ""}`, enabled: A2, liveMode: u2, onLiveEvent: c2, dataProviderName: D, meta: { ...i2, dataProviderName: l2 } });
...
var To = o(({ id: e, resource: t, values: r, dataProviderName: s, successNotification: n, errorNotification: i2, meta: a, metaData: u2, mutationMode: c2, undoableTimeout: p3, onCancel: l2, optimisticUpdateMap: m2, invalidates: y2, mutationOptions: d3, overtimeOptions: T3 } = {}) => {
  let { resources: x, select: v } = q(), f2 = useQueryClient(), P = le(), { mutationMode: M, undoableTimeout: Q } = _e(), g2 = z(), C2 = ie(), { mutate: h } = Re({ v3LegacyAuthProviderCompatible: !!(C2 != null && C2.isLegacy) }), D = Ye(), { log: A2 } = Je(), { notificationDispatch: E2 } = ut(), L2 = Ce(), U = ke(), w = ue(), { options: { textTransformers: N } } = ge(), { keys: b, preferLegacyKeys: F } = Z(), V = useMutation({ mutationFn: ({ id: R2 = e, values: S = r, resource: B = t, mutationMode: H = c2, undoableTimeout: $ = p3, onCancel: X = l2, meta: ne = a, metaData: Y = u2, dataProviderName: O = s }) => {
    ...
    A2 == null || A2.mutate({ action: "update", resource: ae.name, data: Y, previousData: se, meta: { ...rt, dataProviderName: ye, id: H } }), (Ct = d3 == null ? void 0 : d3.onSuccess) == null || Ct.call(d3, R2, S, B);
  }, onError: (R2, S, B) => {
    var O;
...
var Xt = o(({ resource: e, values: t, dataProviderName: r, successNotification: s, errorNotification: n, invalidates: i2, meta: a, metaData: u2, mutationOptions: c2, overtimeOptions: p3 } = {}) => {
  let l2 = ie(), { mutate: m2 } = Re({ v3LegacyAuthProviderCompatible: !!(l2 != null && l2.isLegacy) }), y2 = le(), d3 = ke(), { resources: T3, select: x } = q(), v = z(), f2 = Ye(), { log: P } = Je(), M = Ce(), Q = ue(), { options: { textTransformers: g2 } } = ge(), { keys: C2, preferLegacyKeys: h } = Z(), D = useMutation({ mutationFn: ({ resource: b = e, values: F = t, meta: V = a, metaData: G = u2, dataProviderName: W = r }) => {
    if (!F) throw ho;
    if (!b) throw xo;
    ...
    P == null || P.mutate({ action: "create", resource: S.name, data: re, meta: { ...ae, dataProviderName: $, id: ((we = b == null ? void 0 : b.data) == null ? void 0 : we.id) ?? void 0 } }), (ye = c2 == null ? void 0 : c2.onSuccess) == null || ye.call(c2, b, F, V);
  }, onError: (b, F, V) => {
    var R2;
  ...
  }, mutationKey: C2().data().mutation("create").get(h), ...c2, meta: { ...c2 == null ? void 0 : c2.meta, ...k("useCreate", h) } }), { mutate: A2, mutateAsync: E2, ...L2 } = D, { elapsedTime: U } = fe({ ...p3, isLoading: L2.isLoading });
  return { ...L2, mutate: o((b, F) => A2(b || {}, F), "handleMutation"), mutateAsync: o((b, F) => E2(b || {}, F), "handleMutateAsync"), overtime: { elapsedTime: U } };
}, "useCreate");
...
var Po = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), n = le(), { resources: i2, select: a } = q(), u2 = useQueryClient(), { mutationMode: c2, undoableTimeout: p3 } = _e(), { notificationDispatch: l2 } = ut(), m2 = z(), y2 = Ye(), { log: d3 } = Je(), T3 = Ce(), x = ke(), v = ue(), { options: { textTransformers: f2 } } = ge(), { keys: P, preferLegacyKeys: M } = Z(), Q = useMutation({ mutationFn: ({ id: C2, mutationMode: h, undoableTimeout: D, resource: A2, onCancel: E2, meta: L2, metaData: U, dataProviderName: w, values: N }) => {
    let { resource: b, identifier: F } = a(A2), V = v({ resource: b, meta: I2(L2, U) }), G = h ?? c2, W = D ?? p3;
  ...
  }, onMutate: async ({ id: C2, resource: h, mutationMode: D, dataProviderName: A2, meta: E2, metaData: L2 }) => {
    let { identifier: U } = a(h), { gqlMutation: w, gqlQuery: N, ...b } = I2(E2, L2) ?? {}, F = dt(M)(U, ee(U, A2, i2), b), V = P().data(ee(U, A2, i2)).resource(U), G = D ?? c2;
  ...
  }, onSettled: (C2, h, { id: D, resource: A2, dataProviderName: E2, invalidates: L2 = ["list", "many"] }) => {
    let { identifier: U } = a(A2);
    x({ resource: U, dataProviderName: ee(U, E2, i2), invalidates: L2 }), l2({ type: "REMOVE", payload: { id: D, resource: U } });
  }, onSuccess: (C2, { id: h, resource: D, successNotification: A2, dataProviderName: E2, meta: L2, metaData: U }, w) => {
    ...
    let W = typeof A2 == "function" ? A2(C2, h, b) : A2;
    ...
    d3 == null || d3.mutate({ action: "delete", resource: N.name, meta: { ...te, dataProviderName: V, id: h } }), u2.removeQueries(w == null ? void 0 : w.queryKey.detail(h));
  }, onError: (C2, { id: h, resource: D, errorNotification: A2 }, E2) => {
    let { identifier: L2 } = a(D);
    if (E2) for (let U of E2.previousQueries) u2.setQueryData(U[0], U[1]);
    if (C2.message !== "mutationCancelled") {
      s(C2);
      let U = f2.singular(L2), w = typeof A2 == "function" ? A2(C2, h, L2) : A2;
...
var bo = o(({ resource: e, values: t, dataProviderName: r, successNotification: s, errorNotification: n, meta: i2, metaData: a, invalidates: u2, mutationOptions: c2, overtimeOptions: p3 } = {}) => {
  let l2 = le(), { resources: m2, select: y2 } = q(), d3 = z(), T3 = Ye(), x = Ce(), v = ke(), { log: f2 } = Je(), P = ue(), { options: { textTransformers: M } } = ge(), { keys: Q, preferLegacyKeys: g2 } = Z(), C2 = useMutation({ mutationFn: ({ resource: w = e, values: N = t, meta: b = i2, metaData: F = a, dataProviderName: V = r }) => {
    if (!N) throw Co;
    if (!w) throw Ro;
  ...
  }, mutationKey: Q().data().mutation("createMany").get(g2), ...c2, meta: { ...c2 == null ? void 0 : c2.meta, ...k("useCreateMany", g2) } }), { mutate: h, mutateAsync: D, ...A2 } = C2, { elapsedTime: E2 } = fe({ ...p3, isLoading: A2.isLoading });
  return { ...A2, mutate: o((w, N) => h(w || {}, N), "handleMutation"), mutateAsync: o((w, N) => D(w || {}, N), "handleMutateAsync"), overtime: { elapsedTime: E2 } };
}, "useCreateMany");
...
var ii = o(({ ids: e, resource: t, values: r, dataProviderName: s, successNotification: n, errorNotification: i2, meta: a, metaData: u2, mutationMode: c2, undoableTimeout: p3, onCancel: l2, optimisticUpdateMap: m2, invalidates: y2, mutationOptions: d3, overtimeOptions: T3 } = {}) => {
  let { resources: x, select: v } = q(), f2 = useQueryClient(), P = le(), M = z(), { mutationMode: Q, undoableTimeout: g2 } = _e(), C2 = ie(), { mutate: h } = Re({ v3LegacyAuthProviderCompatible: !!(C2 != null && C2.isLegacy) }), { notificationDispatch: D } = ut(), A2 = Ye(), E2 = Ce(), L2 = ke(), { log: U } = Je(), w = ue(), { options: { textTransformers: N } } = ge(), { keys: b, preferLegacyKeys: F } = Z(), V = useMutation({ mutationFn: ({ ids: R2 = e, values: S = r, resource: B = t, onCancel: H = l2, mutationMode: $ = c2, undoableTimeout: X = p3, meta: ne = a, metaData: Y = u2, dataProviderName: O = s }) => {
    if (!R2) throw Yt;
    if (!S) throw Sr;
    if (!B) throw Zt;
    ...
    E2(Ne, { key: `${H}-${J}-notification`, description: M("notifications.success", "Successful"), message: M("notifications.editSuccess", { resource: M(`${J}.${J}`, J) }, `Successfully updated ${we}`), type: "success" }), A2 == null || A2({ channel: `resources/${ae.name}`, type: "updated", payload: { ids: H.map(String) }, date: /* @__PURE__ */ new Date(), meta: { ...Ve, dataProviderName: ye } });
    let se = [];
    B && H.forEach((Ct) => {
    ...
    let { fields: me, operation: ce, variables: ve, ...rt } = Ve || {};
    U == null || U.mutate({ action: "updateMany", resource: ae.name, data: X, previousData: se, meta: { ...rt, dataProviderName: ye, ids: H } }), (Ke = d3 == null ? void 0 : d3.onSuccess) == null || Ke.call(d3, R2, S, B);
  }, onError: (R2, S, B) => {
    var O;
...
var di = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), { mutationMode: n, undoableTimeout: i2 } = _e(), a = le(), { notificationDispatch: u2 } = ut(), c2 = z(), p3 = Ye(), l2 = Ce(), m2 = ke(), { log: y2 } = Je(), { resources: d3, select: T3 } = q(), x = useQueryClient(), v = ue(), { options: { textTransformers: f2 } } = ge(), { keys: P, preferLegacyKeys: M } = Z(), Q = useMutation({ mutationFn: ({ resource: C2, ids: h, mutationMode: D, undoableTimeout: A2, onCancel: E2, meta: L2, metaData: U, dataProviderName: w, values: N }) => {
    let { resource: b, identifier: F } = T3(C2), V = v({ resource: b, meta: I2(L2, U) }), G = D ?? n, W = A2 ?? i2, K = a(ee(F, w, d3)), j = o(() => K.deleteMany ? K.deleteMany({ resource: b.name, ids: h, meta: V, metaData: V, variables: N }) : lt(h.map((te) => K.deleteOne({ resource: b.name, id: te, meta: V, metaData: V, variables: N }))), "mutationFn");
  ...
  }, onMutate: async ({ ids: C2, resource: h, mutationMode: D, dataProviderName: A2, meta: E2, metaData: L2 }) => {
    let { identifier: U } = T3(h), { gqlMutation: w, gqlQuery: N, ...b } = I2(E2, L2) ?? {}, F = dt(M)(U, ee(U, A2, d3), b), V = P().data(ee(U, A2, d3)).resource(U), G = D ?? n;
  ...
  }, onSettled: (C2, h, { resource: D, ids: A2, dataProviderName: E2, invalidates: L2 = ["list", "many"] }) => {
    let { identifier: U } = T3(D);
    m2({ resource: U, dataProviderName: ee(U, E2, d3), invalidates: L2 }), u2({ type: "REMOVE", payload: { id: A2, resource: U } });
  }, onSuccess: (C2, { ids: h, resource: D, meta: A2, metaData: E2, dataProviderName: L2, successNotification: U }, w) => {
    let { resource: N, identifier: b } = T3(D), F = ee(b, L2, d3), V = v({ resource: N, meta: I2(A2, E2) });
  ...
  }, onError: (C2, { ids: h, resource: D, errorNotification: A2 }, E2) => {
...
var yi = o(({ url: e, method: t, config: r, queryOptions: s, successNotification: n, errorNotification: i2, meta: a, metaData: u2, dataProviderName: c2, overtimeOptions: p3 }) => {
  ...
  if (M) {
    let g2 = useQuery({ queryKey: v().data(c2).mutation("custom").params({ method: t, url: e, ...r, ...P || {} }).get(f2), queryFn: (h) => M({ url: e, method: t, ...r, meta: { ...Q, queryContext: je(h) }, metaData: { ...Q, queryContext: je(h) } }), ...s, onSuccess: (h) => {
      var A2;
      (A2 = s == null ? void 0 : s.onSuccess) == null || A2.call(s, h);
      let D = typeof n == "function" ? n(h, { ...r, ...Q }) : n;
      T3(D);
    }, onError: (h) => {
      var A2;
      y2(h), (A2 = s == null ? void 0 : s.onError) == null || A2.call(s, h);
...
var bi = o(({ resource: e, config: t, filters: r, hasPagination: s, pagination: n, sorters: i2, queryOptions: a, successNotification: u2, errorNotification: c2, meta: p3, metaData: l2, liveMode: m2, onLiveEvent: y2, liveParams: d3, dataProviderName: T3, overtimeOptions: x }) => {
  ...
  let re = useInfiniteQuery({ queryKey: A2().data(L2).resource(P).action("infinite").params({ ...U || {}, filters: w, hasPagination: V, ...V && { pagination: F }, ...i2 && { sorters: i2 }, ...(t == null ? void 0 : t.sort) && { sort: t == null ? void 0 : t.sort } }).get(E2), queryFn: (R2) => {
...
var Pt = o(({ resource: e, params: t, channel: r, types: s, enabled: n = true, liveMode: i2, onLiveEvent: a, dataProviderName: u2, meta: c2 }) => {
  var f2;
  let { resource: p3, identifier: l2 } = q(e), { liveProvider: m2 } = (0, import_react19.useContext)(mt), { liveMode: y2, onLiveEvent: d3 } = (0, import_react19.useContext)(Qe), T3 = i2 ?? y2, x = ke(), v = u2 ?? (c2 == null ? void 0 : c2.dataProviderName) ?? ((f2 = p3 == null ? void 0 : p3.meta) == null ? void 0 : f2.dataProviderName);
...
var fP = o(({ resourceName: e, resource: t, sorter: r, sorters: s, filters: n, maxItemCount: i2, pageSize: a = 20, mapData: u2 = o((x) => x, "mapData"), exportOptions: c2, unparseConfig: p3, meta: l2, metaData: m2, dataProviderName: y2, onError: d3, download: T3 } = {}) => {
  let [x, v] = (0, import_react43.useState)(false), f2 = le(), P = ue(), { resource: M, resources: Q, identifier: g2 } = q(I2(t, e)), h = `${ht()(g2, "plural")}-${(/* @__PURE__ */ new Date()).toLocaleString()}`, { getList: D } = f2(ee(g2, y2, Q)), A2 = P({ resource: M, meta: I2(l2, m2) });
  return { isLoading: x, triggerExport: o(async () => {
    v(true);
    let L2 = [], U = 1, w = true;
    for (; w; ) try {
      let { data: V, total: G } = await D({ resource: (M == null ? void 0 : M.name) ?? "", filters: n, sort: I2(s, r), sorters: I2(s, r), pagination: { current: U, pageSize: a, mode: "server" }, meta: A2, metaData: A2 });
...
var RP = o((e = {}) => {
  var K, j, re;
  let t = ue(), r = ke(), { redirect: s } = kt(), { mutationMode: n } = _e(), { setWarnWhen: i2 } = vt(), a = fn(), u2 = I2(e.meta, e.metaData), c2 = e.mutationMode ?? n, { id: p3, setId: l2, resource: m2, identifier: y2, formAction: d3 } = qe({ resource: e.resource, id: e.id, action: e.action }), [T3, x] = import_react44.default.useState(false), v = d3 === "edit", f2 = d3 === "clone", P = d3 === "create", M = t({ resource: m2, meta: u2 }), Q = (v || f2) && !!e.resource, g2 = typeof e.id < "u", C2 = ((K = e.queryOptions) == null ? void 0 : K.enabled) === false;
  ...
  return { onFinish: F, onFinishAutoSave: V, formLoading: N, mutationResult: U, mutation: U, queryResult: A2, query: A2, autoSaveProps: W, id: p3, setId: l2, redirect: D, overtime: G };
}, "useForm");
...
var he = o(() => {
  let { resources: e } = q(), t = oe(), { useHistory: r } = pe(), s = r(), n = Te(), i2 = Pe(), a = Mo(), u2 = o((g2, C2 = "push") => {
    ...
    let h = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, D = (A2 = Se(h, e).find((E2) => E2.action === "create")) == null ? void 0 : A2.route;
    ...
    let A2 = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, E2 = (L2 = Se(A2, e).find((U) => U.action === "edit")) == null ? void 0 : L2.route;
    return E2 ? i2({ to: We(E2, A2 == null ? void 0 : A2.meta, n, { ...h, id: D }), type: "path", query: h.query }) : "";
    ...
    let A2 = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, E2 = (L2 = Se(A2, e).find((U) => U.action === "clone")) == null ? void 0 : L2.route;
    return E2 ? i2({ to: We(E2, A2 == null ? void 0 : A2.meta, n, { ...h, id: D }), type: "path", query: h.query }) : "";
    ...
    let A2 = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, E2 = (L2 = Se(A2, e).find((U) => U.action === "show")) == null ? void 0 : L2.route;
    return E2 ? i2({ to: We(E2, A2 == null ? void 0 : A2.meta, n, { ...h, id: D }), type: "path", query: h.query }) : "";
  }, "showUrl"), y2 = o((g2, C2 = {}) => {
    var A2;
    if (t === "legacy") {
    ...
    let h = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, D = (A2 = Se(h, e).find((E2) => E2.action === "list")) == null ? void 0 : A2.route;
    return D ? i2({ to: We(D, h == null ? void 0 : h.meta, n, C2), type: "path", query: C2.query }) : "";
  }, "listUrl");
...
var mR = o(({ resourceName: e, resource: t, mapData: r = o((l2) => l2, "mapData"), paparseOptions: s, batchSize: n = Number.MAX_SAFE_INTEGER, onFinish: i2, meta: a, metaData: u2, onProgress: c2, dataProviderName: p3 } = {}) => {
  ...
  let A2 = o(({ file: E2 }) => (h(), new Promise((L2) => {
  ...
  return { inputProps: { type: "file", accept: ".csv", onChange: (E2) => {
    E2.target.files && E2.target.files.length > 0 && A2({ file: E2.target.files[0] });
  } }, mutationResult: C2, isLoading: T3, handleChange: A2 };
}, "useImport");
...
var PC = o((e) => {
  ...
  } }, overtimeOptions: { enabled: false }, successNotification: x, errorNotification: v, meta: j, metaData: j, liveMode: C2, liveParams: L2, onLiveEvent: A2, dataProviderName: N }), { elapsedTime: $ } = fe({ ...b, isLoading: H.isFetching || S.isFetching }), X = (0, import_react57.useMemo)(() => uniqBy_default(D === "in-place" ? [...s, ...i2] : [...i2, ...s], "value"), [s, i2]), ne = (0, import_react57.useRef)(E2), Y = (0, import_react57.useMemo)(() => debounce_default((O) => {
    if (ne.current) {
      r(ne.current(O));
      return;
    }
...
function IC({ initialCurrent: e, initialPageSize: t, hasPagination: r = true, pagination: s, initialSorter: n, permanentSorter: i2 = En, defaultSetFilterBehavior: a, initialFilter: u2, permanentFilter: c2 = Un, filters: p3, sorters: l2, syncWithLocation: m2, resource: y2, successNotification: d3, errorNotification: T3, queryOptions: x, liveMode: v, onLiveEvent: f2, liveParams: P, meta: M, metaData: Q, dataProviderName: g2, overtimeOptions: C2 } = {}) {
  ...
  let or = $t({ resource: Ne, hasPagination: r, pagination: { current: Ke, pageSize: Ge, mode: s == null ? void 0 : s.mode }, filters: F ? St($, ve) : void 0, sorters: V ? Ur(ne, me) : void 0, queryOptions: x, overtimeOptions: C2, successNotification: d3, errorNotification: T3, meta: se, metaData: se, liveMode: A2, liveParams: P, onLiveEvent: f2, dataProviderName: g2 }), Bo = (0, import_react58.useCallback)((Ie) => {
    rt((ot) => St($, Ie, ot));
...
var Ft = o((e, t, r = false) => {
  let s = [], n = ze(e, t);
  for (; n; ) s.push(n), n = ze(n, t);
  return s.reverse(), `/${[...s, e].map((a) => Ae((r ? a.route : void 0) ?? a.identifier ?? a.name)).join("/").replace(/^\//, "")}`;
}, "createResourceKey");
var kn = o((e, t = false) => {
...
var zu = o(({ meta: e, hideOnMissingParameter: t = true } = { hideOnMissingParameter: true }) => {
  let r = z(), s = Ut(), n = oe(), { resource: i2, resources: a } = q(), { pathname: u2 } = Te(), { useLocation: c2 } = pe(), { pathname: p3 } = c2(), l2 = ht(), y2 = `/${((n === "legacy" ? An(p3) : u2 ? An(u2) : void 0) ?? "").replace(/^\//, "")}`, d3 = i2 ? Ft(i2, a, n === "legacy") : y2 ?? "", T3 = import_react63.default.useMemo(() => {
    if (!i2) return [];
    ...
    let f2 = kn(a, n === "legacy"), P = o((M) => M.flatMap((Q) => {
...
var Ao = (0, import_react64.createContext)({});
var Zu = o(({ children: e, value: t }) => {
  let r = Br(), s = (0, import_react64.useMemo)(() => ({ ...r, ...t }), [r, t]);
  return import_react64.default.createElement(Ao.Provider, { value: s }, e);
}, "MetaContextProvider");
var Br = o(() => {
  if (!(0, import_react64.useContext)(Ao)) throw new Error("useMetaContext must be used within a MetaContextProvider");
  return (0, import_react64.useContext)(Ao);
}, "useMetaContext");
var ue = o(() => {
  let { params: e } = Te(), t = Br();
  return o(({ resource: s, meta: n } = {}) => {
    let { meta: i2 } = At(s) ?? { meta: {} }, { filters: a, sorters: u2, current: c2, pageSize: p3, ...l2 } = e ?? {}, m2 = { ...i2, ...l2, ...n };
...
function tc(e) {
  let t = z(), { keys: r, preferLegacyKeys: s } = Z(), n = useQueryClient(), i2 = ke(), { identifier: a, id: u2 } = qe({ resource: e.resource, id: e.id }), { resources: c2 } = q(), p3 = !!n.isFetching({ queryKey: r().data(ee(a, e.dataProviderName, c2)).resource(a).action("one").get(s) }), l2 = o(() => {
...
var Kn = o(({ providers: e, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n, wrapperProps: i2, renderContent: a, formProps: u2, title: c2 = void 0, hideForm: p3, mutationVariables: l2 }) => {
  let m2 = oe(), y2 = yt(), { Link: d3 } = pe(), T3 = m2 === "legacy" ? d3 : y2, [x, v] = (0, import_react71.useState)(""), [f2, P] = (0, import_react71.useState)(""), [M, Q] = (0, import_react71.useState)(false), g2 = z(), C2 = ie(), { mutate: h } = Ht({ v3LegacyAuthProviderCompatible: !!(C2 != null && C2.isLegacy) }), D = o((L2, U) => import_react71.default.createElement(T3, { to: L2 }, U), "renderLink"), A2 = o(() => e ? e.map((L2) => import_react71.default.createElement("div", { key: L2.name, style: { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem" } }, import_react71.default.createElement("button", { onClick: () => h({ ...l2, providerName: L2.name }), style: { display: "flex", alignItems: "center" } }, L2 == null ? void 0 : L2.icon, L2.label ?? import_react71.default.createElement("label", null, L2.label)))) : null, "renderProviders"), E2 = import_react71.default.createElement("div", { ...n }, import_react71.default.createElement("h1", { style: { textAlign: "center" } }, g2("pages.login.title", "Sign in to your account")), A2(), !p3 && import_react71.default.createElement(import_react71.default.Fragment, null, import_react71.default.createElement("hr", null), import_react71.default.createElement("form", { onSubmit: (L2) => {
...
var Rc = o(({ legacyAuthProvider: e, authProvider: t, dataProvider: r, legacyRouterProvider: s, routerProvider: n, notificationProvider: i2, accessControlProvider: a, auditLogProvider: u2, resources: c2, DashboardPage: p3, ReadyPage: l2, LoginPage: m2, catchAll: y2, children: d3, liveProvider: T3, i18nProvider: x, Title: v, Layout: f2, Sider: P, Header: M, Footer: Q, OffLayoutArea: g2, onLiveEvent: C2, options: h }) => {
  let { optionsWithDefaults: D, disableTelemetryWithDefault: A2, reactQueryWithDefaults: E2 } = Jr({ options: h }), L2 = kr(() => {
    var b;
...
var Sc = o(({ resource: e, action: t, params: r, fallback: s, onUnauthorized: n, children: i2, queryOptions: a, ...u2 }) => {
  let { id: c2, resource: p3, action: l2 = "" } = qe({ resource: e, id: r == null ? void 0 : r.id }), m2 = t ?? l2, y2 = r ?? { id: c2, resource: p3 }, { data: d3 } = Ar({ resource: p3 == null ? void 0 : p3.name, action: m2, params: y2, queryOptions: a });
...
papaparse/papaparse.min.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-UUULOIRU.js.map
