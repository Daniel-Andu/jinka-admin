...
var G = ({ children: t }) => {
  let { resources: o } = q(), r = import_react3.default.useMemo(() => T(o), [o]);
  return t ? t(r) : import_react3.default.createElement(Routes, null, r);
};
var O = ({ resource: t, meta: o }) => {
  let r = Ut(), { resource: i, resources: s } = q(t), n = i || s.find((e) => e.list);
  if (n) {
...
var _ = ({ translationKey: t = "warnWhenUnsavedChanges", message: o = "Are you sure you want to leave? You have unsaved changes." }) => {
  let r = z(), { pathname: i } = useLocation(), { warnWhen: s, setWarnWhen: n } = vt();
...
function ce({ handler: t }) {
  var d;
  let o = useLocation(), { action: r, id: i, params: s, pathname: n, resource: e } = Te(), a = z(), c = ht(), f = (e == null ? void 0 : e.identifier) ?? (e == null ? void 0 : e.name), p = (e == null ? void 0 : e.label) ?? ((d = e == null ? void 0 : e.meta) == null ? void 0 : d.label) ?? c(f, r === "list" ? "plural" : "singular"), m = a(`${e == null ? void 0 : e.name}.${e == null ? void 0 : e.name}`, p);
