...
import {
  ...
  q,
  z
} from "./chunk-UUULOIRU.js";
import "./chunk-YTTXJKRG.js";
import {
  require_react_dom
...
// node_modules/kbar/node_modules/fast-equals/dist/fast-equals.js
var require_fast_equals = __commonJS({
  "node_modules/kbar/node_modules/fast-equals/dist/fast-equals.js"(exports, module) {
...
var require_useMatches = __commonJS({
  "node_modules/kbar/lib/useMatches.js"(exports) {
    ...
    var useKBar_1 = require_useKBar();
    var utils_1 = require_utils();
    var command_score_1 = __importDefault(require_command_score());
    exports.NO_GROUP = {
      name: "none",
    ...
    function useInternalMatches(filtered, search) {
      ...
      return React2.useMemo(function() {
        if (throttledSearch.trim() === "") {
          return throttledFiltered.map(function(action2) {
            return { score: 0, action: action2 };
          });
        }
        var matches = [];
...
var require_dist2 = __commonJS({
  "node_modules/@radix-ui/react-slot/dist/index.js"(exports, module) {
    ...
    function createSlot(ownerName) {
      ...
      const Slot2 = React2.forwardRef((props2, forwardedRef) => {
      ...
      const SlotClone = React2.forwardRef((props2, forwardedRef) => {
        ...
        if (React2.isValidElement(children)) {
          ...
          if (children.type !== React2.Fragment) {
            props22.ref = forwardedRef ? (0, import_react_compose_refs.composeRefs)(forwardedRef, childrenRef) : childrenRef;
          }
...
var require_dist3 = __commonJS({
  "node_modules/@radix-ui/react-primitive/dist/index.js"(exports, module) {
    ...
    var Primitive = NODES.reduce((primitive, node) => {
      ...
      const Node = React2.forwardRef((props2, forwardedRef) => {
...
var require_dist5 = __commonJS({
  "node_modules/@radix-ui/react-portal/dist/index.js"(exports, module) {
    ...
    var import_react_use_layout_effect = require_dist4();
    var import_jsx_runtime = require_jsx_runtime();
    var PORTAL_NAME = "Portal";
    var Portal = React2.forwardRef((props2, forwardedRef) => {
      var _a;
...
var require_KBarPortal = __commonJS({
  "node_modules/kbar/lib/KBarPortal.js"(exports) {
    ...
    var react_portal_1 = require_dist5();
    var React2 = __importStar(require_react());
    var types_1 = require_types();
    var useKBar_1 = require_useKBar();
    function KBarPortal(props2) {
      ...
      return React2.createElement(react_portal_1.Portal, null, props2.children);
    }
...
var require_KBarResults = __commonJS({
  "node_modules/kbar/lib/KBarResults.js"(exports) {
    ...
    var KBarResults = function(props2) {
      ...
      }, [search, currentRootActionId, props2.items, query]);
...
var I = r(() => {
  let n = z(), { resource: e, resources: p, id: c, action: y } = q(), l = oe(), d = Ut(), b = Pe(), { mutate: H } = Po(), { push: K, list: Pt, create: wt, show: Tt, edit: kt } = he(), V = ht(), $ = (0, import_react3.useContext)(import_kbar3.KBarContext), { can: a } = cC(), [B, j] = (0, import_react3.useState)([]);
  (0, import_react3.useEffect)(() => {
    r(async () => await Promise.all(q2().flatMap((i) => F(i))), "preaparedActions")().then((i) => j(i.flatMap((m) => m)));
...
var ge = r(({ children: n, commandBarProps: e }) => import_react2.default.createElement(w.Provider, { value: e ?? {} }, import_react2.default.createElement(import_kbar.KBarProvider, null, n)), "RefineKbarProvider");
